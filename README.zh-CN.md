...
<p align="center">
  ...
  <a href="#开始使用">开始使用</a> · <a href="#功能">功能</a> · <a href="#安装">安装</a> · <a href="https://github.com/elfmedy/branch-note/issues">反馈</a>
</p>

## 开始使用

比如，你已经写了一篇 **旅行计划**。想单独整理行李时，右键选择**新建子笔记**，再将新笔记命名为 **行李清单**。
...
点 **旅行计划**，仍然可以阅读、编辑原来的内容；点左侧箭头，就能展开或收起 **行李清单**。原文留在父级，子笔记单独书写。以后也可以为子笔记继续添加下一层。

已经有目录？同样可以右键添加子笔记。点击目录打开它的首页；还没有首页时，点**开始书写**即可创建。
